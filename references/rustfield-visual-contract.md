...
- Reject polished vector geometry, over-reduced icons, rigid rectangles, generic genre substitutes, yellow paper, perfectly snapped seams, absent palette provenance, absent identity anchors, or any result that does not follow the user's actual description. Reject watercolor/gouache/dry-brush or craft-like surfaces only when they contradict the active RISO material contract; do not remove functional perspective or needed structural detail merely to make the image more geometric.
